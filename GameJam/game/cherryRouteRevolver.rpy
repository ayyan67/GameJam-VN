label revolver:
    ...
    "You catch yourself feeling anxious again and remember that you wanted to play pong with Maid."
    ...
    me "{i}Just yesterday, we were all having a wild time playing games here. But now. Joffrey is dead. And I'm forced to suspect everyone around me.{/i}"

    "You grow dizzy. Your surroundings start to distort. Your paranoia heightens."

    me"{i}No one liked Joffrey after all. He harassed both Cherry and Annabelle. Klaus must have been tired of trying to keep him under control.{/i}"
    ...
    me"{i}A revolver. With this. With this, I can find the murderer. I have all the information I need. {/i}" 
